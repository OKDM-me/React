            ...
            <div className="main-content">
                ...
                <div className="user-data">
                    <div className="logo-x-dp">
                        <img src={basicUserDp} alt="" />
                    </div>
                    <div className="name">Riya Bhowmik</div>
                    <div className="about-header">Student @Jadavpur University</div>
                    <div className="about-desc">You like my hair? Gee, thanks, just bought it I see it, I like it, I want it, I got it! 💅🏻</div>
